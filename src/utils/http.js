 ...
 */
function showSuccessNotify(data, withDelay = false) {
 ...
 */
function getErrorResponseMessages(data) {
 ...
 */
async function apiPost(resource, params = null, options = {}) {
  if (options.withLoader) {
    loader("on", resource);
  }
 ...
 */
async function apiPut(resource, params = null, options = {}) {
  if (options.withLoader) {
    loader("on", resource);
  }
 ...
 */
async function apiPatch(resource, params = null, options = {}) {
  if (options.withLoader) {
    loader("on", resource);
  }
